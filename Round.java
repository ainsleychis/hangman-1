/*
This code runs the hangman game within each round

public class round - has all the ints and string needed for the game

public round - chooses a random word

public void current guess - checks to see if the guess if wrong or right

public int run - gives hangman instructions and redirects the user if they enter and invalid guess and tells you your guesses and where it fits in the word
